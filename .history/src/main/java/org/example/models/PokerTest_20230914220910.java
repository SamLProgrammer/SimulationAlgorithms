...
public class PokerTest {
    ...
    private void fillPokerRows(int n) {
        ...
        pokerRows[1] = new PokerRow("Different", allDifferent, 0.3024, 0.3024*n);
        pokerRows[2] = new PokerRow("Different", allDifferent, 0.3024, 0.3024*n);
        pokerRows[3] = new PokerRow("Different", allDifferent, 0.3024, 0.3024*n);
        pokerRows[4] = new PokerRow("Different", allDifferent, 0.3024, 0.3024*n);
        pokerRows[5] = new PokerRow("Different", allDifferent, 0.3024, 0.3024*n);
        pokerRows[6] = new PokerRow("Different", allDifferent, 0.3024, 0.3024*n);
    }
