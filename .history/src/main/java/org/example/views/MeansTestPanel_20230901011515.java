...
public class MeansTestPanel extends JPanel {
    ...
    private void initComponents(Controller controller) {
        ...
        zetValueArea.setName("relativeAlphaRate");
        ...
        inverseHalfAlfaValueArea.setName("zet");
        inverseHalfAlfaValueArea.setFont(new Font("Oswald", Font.PLAIN, 16));
        inverseHalfAlfaValueArea.setAlignmentX(JTextArea.CENTER_ALIGNMENT);
        inverseHalfAlfaValueArea.setAlignmentY(JTextArea.CENTER_ALIGNMENT);
        inverseHalfAlfaValueArea.setLineWrap(true);
        inverseHalfAlfaValueArea.setWrapStyleWord(true);
        inverseHalfAlfaValueArea.setEditable(false);
