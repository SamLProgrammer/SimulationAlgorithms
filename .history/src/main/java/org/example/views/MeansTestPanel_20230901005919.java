...
public class MeansTestPanel extends JPanel {
    ...
    private JComponent belowFindChildByName(JComponent jComponent, String name) {
        ...
        if(jComponent.getComponents().length > 0) {
            ...
            for (Component childJComponent : jComponent.getComponents()) {
                if(childJComponent instanceof JComponent) {
                    childComponent = belowFindChildByName(childJComponent, name);
