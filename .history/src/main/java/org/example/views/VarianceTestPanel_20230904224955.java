...
public class VarianceTestPanel extends JPanel {
    ...
    private void initComponents(Controller controller) {
        ...
        JLabel righLimitLabel = new JLabel("R.L2.", SwingConstants.CENTER);
        JPanel auxContainer = new JPanel(new BorderLayout());
        // auxContainer.setMinimumSize(new Dimension(50, 50));
        rightLimitArea = new JTextArea(1, 5);
        rightLimitArea.setName("rightLimit");
        setStatsAreaProperties(rightLimitArea);
        auxContainer.add(righLimitLabel, BorderLayout.WEST);
        auxContainer.add(rightLimitArea);
        parametersPanel.add(auxContainer, calculatedResultsConstraint9);
