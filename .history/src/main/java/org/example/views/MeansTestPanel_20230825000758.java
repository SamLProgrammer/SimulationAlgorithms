...
public class MeansTestPanel extends JPanel{
    ...
    private void initComponents(Controller controller) {
        ...
        JPanel acceptanceLevelContainer = new JPanel(new BorderLayout());
    ...
    private void setComponentListener() {
        addComponentListener(new ComponentAdapter() {
            ...
            public void componentResized(ComponentEvent e) {
                ...
                System.out.println(findParentJPanel(acceptanceLevelField).getName());
            }
        });
    }

    private JPanel findParentJPanel(Component component) {
        if (component == null) {
            return null;
        }
        ...
        if (component instanceof JPanel) {
            ...
            return findParentJPanel(component.getParent());
        }
    }
}