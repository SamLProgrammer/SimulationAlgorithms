...
public class MeansTestPanel extends JPanel {
    ...
    private void initComponents(Controller controller) {
        ...
        childConstraints.weightx = 0.3; // 30% of parent's width
        childConstraints.weighty = 0.1; // 10% of parent's height
        childConstraints.fill = GridBagConstraints.BOTH; // Expand in both directions
