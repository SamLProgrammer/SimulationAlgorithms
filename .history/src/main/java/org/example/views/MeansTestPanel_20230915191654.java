...
public class MeansTestPanel extends JPanel {
    ...
    private void initComponents(Controller controller) {
        ...
        JLabel averageLabel = new JLabel("Mean: ");
    ...
    private void setMouseListenerOnSubmitButton() {
        submitButton.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                MeansTestResult meansTestResult = invokeMeansTest();
                Map<String, Double> statsMap = meansTestResult.getStatsMap();
                ...
                myInstance().RiTable.updateRowsTable(meansTestResult.getMeansTableData());
            }
        });
    }
    ...
    private MeansTestResult invokeMeansTest() {
