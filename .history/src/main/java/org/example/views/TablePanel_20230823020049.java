...
public class TablePanel extends JPanel {
    ...
    IndexedCellRenderer indexedCellRenderer;

    public TablePanel() {
        setLayout(new BorderLayout());
        model = new DefaultTableModel();
        indexedCellRenderer = new IndexedCellRenderer();
    ...
    public void updateRowsTable(String[][] dataMatrix) {
        ...
        for (int i = 0; i < dataMatrix.length; i++) {
            ...
            dataTable.getColumnModel().getColumn(1).setCellRenderer(indexedCellRenderer);			
            dataTable.getColumnModel().getColumn(1).setCellEditor(new IndexedCellEditor(new JTextField()));
        }
    }
