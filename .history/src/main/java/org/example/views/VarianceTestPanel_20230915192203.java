...
public class VarianceTestPanel extends JPanel {
    ...
    private void initComponents(Controller controller) {
        ...
        resultMainContainer.add(Box.createRigidArea(new Dimension(0, 3)));
        ...
        calculatedResultsConstraint7.gridheight = 1;
    ...
    private void setMouseListenerOnSubmitButton() {
        submitButton.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                VarianceTestResult varianceTestResult = invokeVarianceTest();
                Map<String, Double> statsMap = varianceTestResult.getStatsMap();
                ...
                myInstance().RiTable.updateRowsTable(varianceTestResult.getVarianceTableData());
            }
        });
    }
    ...
    private void setKeyListenerOnAcceptanceRate() {
        acceptanceLevelField.addKeyListener(new KeyAdapter() {
            ...
            public void keyReleased(KeyEvent e) {
                validateAcceptanceRate(acceptanceLevelField.getText());
            }
        });
    }
    ...
    private VarianceTestResult invokeVarianceTest() {
        String stringValue = acceptanceLevelField.getText().replace(",", ".");
    ...
    private void validateAcceptanceRate(String text) {
        boolean valid = isValidDecimal(text);
        if(valid) {
            submitButton.setEnabled(true);
            acceptanceLevelField.setBorder(null);
        } else {
            submitButton.setEnabled(false);
            acceptanceLevelField.setBorder(BorderFactory.createLineBorder(Color.RED, 2));
        }
    }
    ...
    private boolean isValidDecimal(String text) {
        ...
        for(int i = 0; i < text.length(); i++) {
            ...
            valid  = valid && (!((c < 48 || c > 57) && c != 46 && c != 44 && c != 8));
        }
        return valid;
    }
}