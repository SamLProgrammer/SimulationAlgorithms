...
public class PokerTestPanel extends JPanel {
    ...
    private void initComponents(Controller controller) {
        ...
        JPanel northContainerPanel = new JPanel(new GridLayout(2, 1, 0, 3));
        northContainerPanel.add(percentageContainer);
        northContainerPanel.add(alphaContainer);
        ...
        acceptanceLevelContainer.add(northContainerPanel);
        ...
        calculatedResultsConstraint1.weighty = 0.75;
    ...
    private void setKeyListenerOnAcceptanceRate() {
        acceptanceLevelField.addKeyListener(new KeyAdapter() {
            ...
            public void keyReleased(KeyEvent e) {
                validateAcceptanceRate(acceptanceLevelField.getText().toString());
            }
        });
