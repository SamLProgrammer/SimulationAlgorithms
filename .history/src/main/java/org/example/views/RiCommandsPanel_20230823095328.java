...
public class RiCommandsPanel extends JPanel {
    ...
    private void initComponents(Controller controller) {
        ...
        algorithmChooserBox.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                switch (algorithmChooserBox.getSelectedItem().toString()) {
                    case "Congruential":
                        statsContainer.remove(statsContainerMiddleSquares);
                        fillStatsPanelForCongruential();
                        myInstance().repaint();
                        break;
                        case "Middle Squares":
                        statsContainer.remove(statsContainerCongruential);
        ...
        statsContainer = new JPanel(new GridLayout(1, 4, 10, 10));
        fillStatsPanelForCongruential();
    ...
    private void fillStatsPanelForCongruential() {
        ...
        statsContainerMiddleSquares.add(x0Container);
        ...
        statsContainerMiddleSquares.add(cContainer);
        ...
        statsContainerMiddleSquares.add(kContainer);
        ...
        statsContainerMiddleSquares.add(gContainer);
    }

    private void fillStatsPanelForMiddleSquares() {
        statsContainerMiddleSquares = new JPanel();
        statsContainerMiddleSquares.setBackground(Color.green);
    }
