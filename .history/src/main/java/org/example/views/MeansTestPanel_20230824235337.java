...
public class MeansTestPanel extends JPanel {
    ...
    private void initComponents(Controller controller) {
        ...
        parametersPanel.add(alfaValueLabel, alfaValueConstraints);

        GridBagConstraints halfAlfaValueConstraints = new GridBagConstraints();
        halfAlfaValueConstraints.gridx = 0;
        halfAlfaValueConstraints.gridy = 2;
        halfAlfaValueConstraints.gridwidth = 1;
        halfAlfaValueConstraints.gridheight = 1;
        halfAlfaValueConstraints.weightx = 1.0; // Full width
        halfAlfaValueConstraints.weighty = 0.2; // 20% height
        halfAlfaValueConstraints.fill = GridBagConstraints.BOTH;
        parametersPanel.add(halfAlfaValueLabel, halfAlfaValueConstraints);

        // Similar constraints for inverseHalfAlfaValueLabel and zetValueLabel...
        ...
        paramsAndResultsContainerConstraints.weightx = 0.4; // 40% width
