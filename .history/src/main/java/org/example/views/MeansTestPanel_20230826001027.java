    ...
    private void setComponentListener() {
        addComponentListener(new ComponentAdapter() {
            ...
            public void componentResized(ComponentEvent e) {
                ...
                System.out.println(parentPanel.getName() + "x");
                parentPanel.setBackground(Color.red);
                int width = (int) (parentPanel.getWidth() * 0.3);
                int height = (int) acceptanceLevelField.getHeight();
                acceptanceLevelField.setMaximumSize(new Dimension(width, height));
                acceptanceLevelField.setMinimumSize(new Dimension(width, height));
                JLabel percentageLabel = new JLabel("%");
                percentageLabel.setBounds(acceptanceLevelField.getX()-5, acceptanceLevelField.getY(),
                acceptanceLevelField.getWidth()/2, acceptanceLevelField.getHeight());
            }
        });
    }
