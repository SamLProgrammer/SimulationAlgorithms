...
public class RiCommandsPanel extends JPanel {
    ...
    private ArrayList<JTextField> toValidateFieldsCongruential;
    private ArrayList<JTextField> toValidateFieldsSquared;
    ...
    private void initJTextFields() {
        toValidateFieldsCongruential = new ArrayList<>();
        toValidateFieldsSquared = new ArrayList<>();
        ...
        toValidateFieldsCongruential.add(x0TextField);
        toValidateFieldsCongruential.add(kTextField);
        toValidateFieldsCongruential.add(cTextField);
        toValidateFieldsCongruential.add(gTextField);
        toValidateFieldsCongruential.add(iTextField);
        toValidateFieldsSquared.add(seedTextField);
        toValidateFieldsSquared.add(nTextField);
    }
    ...
    private void setupTextFieldsListener() {
        for (JTextField jTextField : toValidateFieldsCongruential) {
        ...
        for (JTextField jTextField : toValidateFieldsSquared) {
            jTextField.addKeyListener(new KeyAdapter() {
                @Override
                public void keyReleased(KeyEvent e) {
                    submitGenerationButton.setEnabled(validateFieldsSet(toValidateFieldsSquared));
                }
            });
        }
    }

    private boolean validateFieldsSet(ArrayList<JTextField> toValidateFields) {
        boolean valid = true;
