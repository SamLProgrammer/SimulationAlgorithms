...
public class MeansTestPanel extends JPanel {
    ...
    private void initComponents(Controller controller) {
        ...
        acceptanceLevelField = new JTextArea(2,5);
        ...
        alphaValueArea = new JTextArea(2,5);
        ...
        halfAlfaValueArea = new JTextArea(2,5);
        ...
        zetValueArea = new JTextArea(2,5);
        ...
        inverseHalfAlfaValueArea = new JTextArea(2,5);
