...
public class VarianceTestPanel extends JPanel {
    ...
    private void initComponents(Controller controller) {
        ...
        parametersPanel.add(halfAlphaContainer);
        ...
        parametersPanel.add(inverseHalfAlphaContainer);
        ...
        parametersPanel.add(leftLimitContainer);
        ...
        parametersPanel.add(rightLimitContainer);
        ...
        parametersPanel.add(halfAlphaXContainer);
        ...
        parametersPanel.add(inverseHalfAlphaXContainer);
