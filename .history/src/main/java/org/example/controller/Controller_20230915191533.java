...
public class Controller {
    ...
    public MeansTestResult invokeMeansTest(double acceptanceRate) {
        return new MeansTestResult(tests.invokeMeansTest(acceptanceRate, randomAlgorithms.getCurrentRandomList()), createRandomsTableData(randomAlgorithms.getCurrentRandomList(), 0));
    }
